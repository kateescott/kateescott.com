        ...
        <ProjectLayout>
                ...
                <div className={styles.text}>
                    ...
                    <ol className={styles.list}>
                        <li>Personalisation and relevance: The UI design aimed to provide personalised learning
                            experiences by adapting to each user&apos;s skills, occupation history, and career goals.
                            This
            ...
            <section className={styles.section}>
                <div className={styles.text}>
                    ...
                    <p>
                        By implementing these design principles, Pearson LearnMate&apos;s UI enhancement focused on
                        creating
