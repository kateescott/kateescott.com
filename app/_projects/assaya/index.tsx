        ...
        <ProjectLayout>
            <section className={styles.section}>
                <ProjectInfo
                    ...
                    description={
                        <p>Assaya collaborates with NGOs in remote Aboriginal communities to combat HIV/AIDS. Through innovative solutions and support, Assaya enhances the efforts of NGOs in preventing the spread of HIV/AIDS and improving healthcare outcomes.</p>
                    }
            ...
            <section className={styles.section}>
                <div className={styles.text}>
                    ...
                    <p>
                    The research has revealed valuable insights into the challenges and pain points associated with addressing HIV/AIDS in remote Aboriginal communities. Key insights include:                    </p>
                    <ol className={styles.list}>
                        <li>There is a need for targeted interventions in remote Aboriginal communities.
                        </li>
                        <li>Tailored strategies are crucial to address the unique challenges faced by these communities.                      </li>
            ...
            <section className={styles.section}>
                <div className={styles.text}>
                    ...
                    <ol className={styles.list}>
                        <li>Enhanced dashboard: Assaya's dashboard will provide real-time monitoring capabilities, allowing NGOs to track and analyse data related to HIV/AIDS prevalence, testing, and intervention outcomes.
                        </li>
                        <li>Streamlined test result tracking: The dashboard will be optimised to facilitate efficient tracking and management of test results, ensuring timely diagnosis and appropriate follow-up.
                        </li>
                        <li>Expanded resources: Assaya will expand its resources, including educational materials and support services, to empower partner NGOs in their efforts to prevent the spread of HIV/AIDS and improve healthcare outcomes.
                        </li>
                    </ol>
                </div>
            </section>
